  ...
  ja: {
    ...
    sections: [
      ...
      },
      {
        ...
        detail: '現在、108項目の検算（統計量・p値・APA形式のレポート文・多言語表示の整合性を含む）がすべて一致しています。',
        link: {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        detail: 'Currently, all 108 checks pass — covering test statistics, p-values, APA-style report strings, and consistency of the Japanese/English translations.',
        link: {
